...
//Q1.2: Complete the xScaleBar and yScaleBar
    // Step 1: 数据聚合（按站点统计人数）
const stationCounts = d3.rollups(
    data,
...
// Step 2: 转换成对象格式
const barData = stationCounts.map(d => ({
    station: d[0],
    value: d[1]
}));
            ...
            <Row className='justify-content-md-center'>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        <ScatterPlot offsetX={margin.left} offsetY={margin.top} data={barData} xScale={xScaleScatter} yScale={yScaleScatter} 
